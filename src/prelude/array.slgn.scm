...
(define byte_array s8vector)
(define (make_byte_array dim #!optional (fill 0)) (make-s8vector dim fill))
(define is_byte_array s8vector?)
(define byte_array_length s8vector-length)
(define byte_array_at s8vector-ref)
(define byte_array_set s8vector-set!)
(define byte_array_to_list s8vector->list)
(define list_to_byte_array list->s8vector)
(define byte_array_fill s8vector-fill!)
(define byte_subarray_fill subs8vector-fill!)
(define byte_array_append s8vector-append)
(define byte_array_copy s8vector-copy)
(define byte_subarray subs8vector)
(define byte_subarray_move subs8vector-move!)
(define byte_array_shrink s8vector-shrink!)

(define ubyte_array u8vector)
(define (make_ubyte_array dim #!optional (fill 0)) (make-u8vector dim fill))
(define is_ubyte_array u8vector?)
(define ubyte_array_length u8vector-length)
(define ubyte_array_at u8vector-ref)
(define ubyte_array_set u8vector-set!)
(define ubyte_array_to_list u8vector->list)
(define list_to_ubyte_array list->u8vector)
(define ubyte_array_fill u8vector-fill!)
(define ubyte_subarray_fill subu8vector-fill!)
(define ubyte_array_append u8vector-append)
(define ubyte_array_copy u8vector-copy)
(define ubyte_subarray subu8vector)
(define ubyte_subarray_move subu8vector-move!)
(define ubyte_array_shrink u8vector-shrink!)
