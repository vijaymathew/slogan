...
(define is_string_gteq string>=?)
(define is_string_lt string<?)
(define is_string_gt string>?)
(define is_string_ci_eq string-ci=?)
(define is_string_ci_lteq string-ci<=?)
(define is_string_ci_gteq string-ci>=?)
(define is_string_ci_lt string-ci<?)
(define is_string_ci_gt string-ci>?)
